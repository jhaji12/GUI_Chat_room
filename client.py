...
# Create a new client socket same way like we did for server and connect to the server
client = socket.socket(socket.AF_INET,
                       socket.SOCK_STREAM)
client.connect(ADDRESS)


# By the use of Tkinter library create a GUI(Graphical User Interface) chatbox class for the chat
class chatbox:
    # constructor method
    def __init__(self):
